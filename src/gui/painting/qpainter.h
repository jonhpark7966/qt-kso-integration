...
public:
    ...
    void drawImage(const QRectF &r, const QImage &pm, const QRectF &sr, const QImageEffects *userData,
                   Qt::ImageConversionFlags flags = Qt::AutoColor); 
    void drawImage(const QRectF &targetRect, const QByteArray &bytes, const QRectF &sourceRect,
                   const QImageEffects *effects = NULL, Qt::ImageConversionFlags flags = Qt::AutoColor);
